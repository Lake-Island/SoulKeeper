local _, core = ...
-- TODO: Swapping shards doesnt work
...
item_frame:SetScript("OnEvent",
  function(self, event, ...)
    ...
    -- CHECKS IF SOUL BAG HAS NEXT AVAILABLE SLOT; IF NOT THEN REGULAR BAG; OTHERWISE NULL
...
cast_success_frame:SetScript("OnEvent", 
  function(self,event,...)
    ...
    local spell_name = GetSpellInfo(spell_id)
    -- TODO: Replace with a helper function that checks if skill was any that 
...
bag_slot_unlock_frame:SetScript("OnEvent",
  function(self, event, ...)
    ...
    if item_id == core.SOUL_SHARD_ID then
      ...
      -- TODO: Print associated mapped name
